      ...
      >
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          ...
          <p className={`${styles.paragraph} ml-2`}>
            <span className="text-white">KSJ </span> Recruitment Private Limited
            - <span className="text-white">Founded</span> in the Year 2015
          </p>
        </div>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          We’re professionals and will grow your business!
        </p>
      </div>
